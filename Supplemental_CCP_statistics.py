...
# -*- coding: utf-8 -*-
"""
Created on Mon Oct 13 18:11:32 2025
...
with pygmt.config(FONT="12p", MAP_ANNOT_OFFSET="10p", MAP_LABEL_OFFSET="10p"):
    ...
    with pygmt.config(FONT_ANNOT_PRIMARY="20p", FONT_LABEL="20p"):
        fig.colorbar(cmap=True, position='jLB+w{}/0.5c+o0c/-1c+h'.format(fig_x/2), frame='xa{}f{}+l{}'.format(
            (sca[1] - sca[0]) / 2, (sca[1] - sca[0]) / 5, 'Bin Hits (<12 km)'))
...
with pygmt.config(FONT="12p", MAP_ANNOT_OFFSET="10p", MAP_LABEL_OFFSET="10p"):
    ...
    with pygmt.config(FONT_ANNOT_PRIMARY="20p", FONT_LABEL="20p"):
        fig.colorbar(cmap=True, position='jLB+w{}/0.5c+o0c/-1c+h'.format(fig_x/2), frame='xa{}f{}+l{}'.format(
            (sca[1] - sca[0]) / 2, (sca[1] - sca[0]) / 5, 'Bin Hits (<4 km)'))
...
with pygmt.config(FONT="12p", MAP_ANNOT_OFFSET="10p", MAP_LABEL_OFFSET="10p"):
    ...
    with pygmt.config(FONT_ANNOT_PRIMARY="20p", FONT_LABEL="20p"):
        fig.colorbar(cmap=True, position='jLB+w{}/0.5c+o0c/-1c+h'.format(fig_x/2), frame='xa{}f{}+l{}'.format(
            (sca[1] - sca[0]) / 2, (sca[1] - sca[0]) / 5, 'Bin STD'))
...
with pygmt.config(FONT="12p", MAP_ANNOT_OFFSET="10p", MAP_LABEL_OFFSET="10p"):
    ...
    with pygmt.config(FONT_ANNOT_PRIMARY="20p", FONT_LABEL="20p"):
        fig.colorbar(cmap=True, position='jLB+w{}/0.5c+o0c/-1c+h'.format(fig_x/2), frame='xa{}f{}+l{}'.format(
            (sca[1] - sca[0]) / 2, (sca[1] - sca[0]) / 5, 'Back Azimuth Concentration'))
...
fig.savefig('../FIGURES/CCP_Model_Statistics.png', dpi = 300)
